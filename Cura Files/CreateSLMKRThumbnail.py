...
class CreateSLMKRThumbnail(Script):
    def __init__(self):
        super().__init__()
    ...
    def _encodeSnapshot(self, snapshot):
        ...
        try:
            ...
            thumbnail_image.save(thumbnail_buffer, "BMP")
    ...
    def _convertSnapshotToGcode(self, encoded_snapshot, width, height, chunk_size=78):
        ...
        chunks = [";IMGDATA:{}".format(encoded_snapshot[i:i+chunk_size])
    ...
    def getSettingDataString(self):
        return """{
            "name": "Create SolidMaker Thumbnail",
            "key": "CreateSLMKRThumbnail",
            "metadata": {},
            "version": 2,
            "settings":
            {
    ...
    def execute(self, data):
        ...
        if snapshot:
            ...
            for layer in data:
                ...
                for line in lines:
                    if line.startswith(";SLDMKRIMGHERE"):
